...
#   write_csv(path = "analysis/R/C038_0022_peptides_pool.csv")
...
# C038_0031_pool %>%
#   select(library_member, sequence, allele, mhc_ii_allele, effectId, variantId, gene_name, peptide, ashion_id) %>%
#   write_csv(path = "analysis/R/C038_0031_peptides_pool.csv")
...
# C038_0036_pool %>%
#   select(library_member, sequence, allele, mhc_ii_allele, effectId, variantId, gene_name, peptide, ashion_id) %>%
#   write_csv(path = "analysis/R/C038_0036_peptides_pool.csv")
...
table(TM2_PepSeq_peptides_AE_selected$ashion_id)
# Need to fill in 11 peptides from 6 alleles, so will select 2 per allele for a total of 18.
C038_0038_peptides_list_min <- reduce(1:2, get_top_allele_per_peptide, .init=C038_0038_start_list)$top
...
# C038_0038_pool %>%
#   select(library_member, sequence, allele, mhc_ii_allele, effectId, variantId, gene_name, peptide, ashion_id) %>%
#   write_csv(path = "analysis/R/C038_0038_peptides_pool.csv")
...
table(TM2_PepSeq_peptides_AE_selected$ashion_id)
# Need to fill in 20 peptides from 5 alleles, so will select 4 per allele.
...
# C038_0044_pool %>%
#   select(library_member, sequence, allele, mhc_ii_allele, effectId, variantId, gene_name, peptide, ashion_id) %>%
#   write_csv(path = "analysis/R/C038_0044_peptides_pool.csv")
