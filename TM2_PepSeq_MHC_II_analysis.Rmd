...
C038_0038_MHC_II_pool <- bind_rows(patient_peps_C038_0038_1104, patient_peps_C038_0038_0302_3XPool.48) %>%
  select(library_member, variantId, gene_name, topEffect, sourceName, file, peptide, sequence)
create_dt(C038_0038_MHC_II_pool)
#write_csv(C038_0038_MHC_II_pool, "C038_0038_MHC_II_pool.csv")
```
...
#write_csv(patient_peps_C038_0044_0303, "patient_peps_C038_0044_0303.csv")
```
...
#write_csv(C038_0044_MHC_II_pool, "C038_0044_MHC_II_pool.csv")
```
